 ...
 */
export async function createAccount({ loginId, name, role, courseId, org, phone, region, rank, password }) {
  const res = await createAccountFn({
    loginId, name, role, courseId, org, phone, region, rank, password: password || undefined,
  });
